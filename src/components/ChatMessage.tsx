  ...
  return <div className={cn("py-6 px-2 md:px-4 w-full animate-message-fade-in relative backdrop-blur-sm", isAi ? "bg-[#1A1F2C]/50" : "bg-[#1A1F2C]/30")} id={`message-${message.slice(0, 10)}`}>
      <div className="max-w-5xl mx-auto flex gap-4">
        ...
        <div className="flex-1 space-y-2">
          <div className={cn("p-4 rounded-xl text-white shadow-lg", isAi ? "bg-gradient-to-br from-[#2A2F3C] to-[#1A1F2C] border border-[#9b87f5]/10" : "bg-gradient-to-br from-[#D946EF] to-[#8B5CF6]")}>
