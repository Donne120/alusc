...
export const MiniChatbotContentUpdated = () => {
  ...
  // Convert settings to AI persona format used by the mini chatbot
  const aiPersona = {
    name: savedPersona === "nyptho" ? "Nyptho Learning AI" : 
          savedPersona === "academic" ? "Academic Advisor" :
          savedPersona === "creative" ? "Creative Coach" :
          savedPersona === "technical" ? "Technical Assistant" :
          savedPersona === "supportive" ? "Supportive Guide" : "Custom AI",
    traits: aiTraits
  };
